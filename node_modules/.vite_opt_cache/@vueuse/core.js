import { s as shallowRef, w as watchEffect, r as readonly, a as ref, b as watch, c as customRef, e as effectScope, g as getCurrentScope, o as onScopeDispose, i as isRef, u as unref, d as computed, f as reactive, t as toRef, h as toRefs$1, j as getCurrentInstance, k as onBeforeMount, n as nextTick, l as onBeforeUnmount, m as onMounted, p as onUnmounted, q as provide, v as inject, x as isReactive, y as onUpdated, z as markRaw, A as onBeforeUpdate } from '../common/runtime-dom.esm-bundler-a65c2919.js';
...
function useRefHistory(source, options = {}) {
  ...
  const manualHistory = useManualRefHistory(source, __spreadProps$6$1(__spreadValues$f({}, options), { clone: options.clone || deep, setSource }));
  ...
  return __spreadProps$6$1(__spreadValues$f({}, manualHistory), {
    isTracking,
    pause,
    resume,
    commit,
...
function useDebouncedRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(source, __spreadProps$5$1(__spreadValues$e({}, options), { eventFilter: filter }));
  ...
  function useFactoryFetch(url, ...args) {
    ...
    if (args.length > 0) {
      if (isFetchOptions(args[0])) {
        ...
        fetchOptions = __spreadProps$3$1(__spreadValues$b(__spreadValues$b({}, fetchOptions), args[0]), {
...
function useFetch(url, ...args) {
  ...
  const execute = async (throwOnFailed = false) => {
    ...
    if (supportsAbort) {
      ...
      fetchOptions = __spreadProps$3$1(__spreadValues$b({}, fetchOptions), {
    ...
    return new Promise((resolve, reject) => {
      var _a3;
      fetch(context.url, __spreadProps$3$1(__spreadValues$b(__spreadValues$b({}, defaultFetchOptions), context.options), {
  ...
  function setMethod(method) {
    return (payload, payloadType) => {
      if (!isFetching.value) {
        ...
        return __spreadProps$3$1(__spreadValues$b({}, shell), {
...
function useFileSystemAccess(options = {}) {
  ...
  async function open(_options = {}) {
    if (!isSupported)
      return;
    const [handle] = await window.showOpenFilePicker(__spreadValues$9$1(__spreadValues$9$1({}, unref(options)), _options));
  ...
  async function create(_options = {}) {
    if (!isSupported)
      return;
    fileHandle.value = await window.showSaveFilePicker(__spreadValues$9$1(__spreadValues$9$1({}, unref(options)), _options));
    data.value = void 0;
    await updateFile();
    await updateData();
  }
...
const useImage = (options, asyncStateOptions = {}) => {
  const state = useAsyncState(() => loadImage(unref(options)), void 0, __spreadValues$8$1({
    resetOnExecute: true
  }, asyncStateOptions));
...
function useInfiniteScroll(element, onLoadMore, options = {}) {
  ...
  const state = reactive(useScroll(element, __spreadProps$2$1(__spreadValues$7$1({}, options), {
    offset: __spreadValues$7$1({
...
function useMediaControls(target, options = {}) {
  options = __spreadValues$6$1(__spreadValues$6$1({}, defaultOptions), options);
  const {
    document = defaultDocument
  } = options;
...
function useShare(shareOptions = {}, options = {}) {
  ...
  const share = async (overrideOptions = {}) => {
    if (isSupported) {
      const data = __spreadValues$3$1(__spreadValues$3$1({}, unref(shareOptions)), unref(overrideOptions));
      let granted = true;
...
function useThrottledRefHistory(source, options = {}) {
  ...
  const history = useRefHistory(source, __spreadProps$9(__spreadValues$2$1({}, options), { eventFilter: filter }));
  return __spreadValues$2$1({}, history);
}
